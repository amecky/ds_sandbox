...
bool _TweakValue(const char* file, size_t counter, bool orgValue);
...
bool _TweakValue(const char* file, size_t counter, bool orgValue) {
	...
	if (tv) {
		...
		return tv__addTweakable(file, counter, twk)->bValue;
	}
}
