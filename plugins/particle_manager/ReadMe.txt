========================================================================
    DYNAMIC LINK LIBRARY: particle_manager-Projektübersicht
========================================================================

Diese particle_manager-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre particle_manager-Anwendung besteht.


particle_manager.vcxproj
...
particle_manager.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen particle_manager.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
